for myDir = ["train/CelebA20K"]%["valid/Manga109", "valid/BSDS100", "valid/DIV2K_valid", "valid/Urban100", "valid/Set5", "valid/Set14", "train/BSDS200", "train/DIV2K", "train/General100", "train/T91"]
    disp(myDir)
